 ...
 */
/**
 * @file   BOARD_DFROBOT_FIREBEETLE_ESP32_P4_LCD_5.h
 * @brief  Configuration file for DFRobot FIREBEETLE-ESP32-P4-LCD-5
 * @author DFRobot
...
#define ESP_PANEL_BOARD_BACKLIGHT_TYPE          (ESP_PANEL_BACKLIGHT_TYPE_IIC)
    ...
    /**
     * @brief I2C backlight initialization sequence
     * 
     * Define the sequence of commands to initialize the backlight
     * Format: {command, data, delay_ms}
     */
     ...
     */
    #define ESP_PANEL_BOARD_BACKLIGHT_IIC_FUNCTION(percent, user_data)  \
        do { \
            (void)percent; \
            (void)user_data; \
        } while (0)
