...
#include "drivers/esp_panel_drivers_conf_internal.h"
    ...
    */
        ...
        #define ESP_PANEL_DRIVERS_BACKLIGHT_USE_IIC             (1)
    #else
        ...
        #ifndef ESP_PANEL_DRIVERS_BACKLIGHT_USE_IIC
            #ifdef CONFIG_ESP_PANEL_DRIVERS_BACKLIGHT_USE_IIC
                #define ESP_PANEL_DRIVERS_BACKLIGHT_USE_IIC CONFIG_ESP_PANEL_DRIVERS_BACKLIGHT_USE_IIC
            #else
                #define ESP_PANEL_DRIVERS_BACKLIGHT_USE_IIC (0)
            #endif
        #endif
...
#ifndef ESP_PANEL_DRIVERS_BACKLIGHT_ENABLE_IIC
    #if ESP_PANEL_DRIVERS_BACKLIGHT_COMPILE_UNUSED_DRIVERS || ESP_PANEL_DRIVERS_BACKLIGHT_USE_IIC
        #define ESP_PANEL_DRIVERS_BACKLIGHT_ENABLE_IIC  (1)
    #else
        #define ESP_PANEL_DRIVERS_BACKLIGHT_ENABLE_IIC  (0)
    #endif
#endif
