...
#include "port/esp_lcd_nodsiconf.h"
#include "esp_panel_lcd_nodsiconf.hpp"

namespace esp_panel::drivers {

// *INDENT-OFF*
const LCD::BasicBusSpecificationMap LCD_NODSICONF::_bus_specifications = {
    {
